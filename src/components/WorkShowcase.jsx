            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="max-w-3xl">
                    ...
                    >
                        <a
                            href="/case-studies"
                            className="inline-flex items-center gap-2 rounded-full px-4 py-2 bg-slate-900 text-white text-sm font-medium shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-300"
                        >
                            View Case Studies
                        </a>
